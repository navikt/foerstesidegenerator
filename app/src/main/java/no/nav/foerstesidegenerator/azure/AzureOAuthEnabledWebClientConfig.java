...
import static no.nav.foerstesidegenerator.azure.AzureProperties.CLIENT_REGISTRATION_DOKMET;
...
public class AzureOAuthEnabledWebClientConfig {
	...
	@Bean
	List<ClientRegistration> clientRegistration(AzureProperties azureProperties, FoerstesidegeneratorProperties dokdistkanalProperties) {
		return List.of(
