...
class MetaforceMapperTest {
	...
	void shouldMapDefaultNetsPostboks() {
		...
		assertEquals(NB.value(), documentElement.getElementsByTagName("spraakkode").item(0).getTextContent());
		...
		assertEquals(SKJEMA.value(), documentElement.getElementsByTagName("foerstesideType").item(0).getTextContent());
