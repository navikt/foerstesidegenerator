...
//
//	@Mock
//	private CreateDocumentRequestTo requestTo;
//
//	@InjectMocks
...
//		CreateDocumentResponseTo responseTo = metaforceConsumer.createDocument(new CreateDocumentRequestTo("metafile", "document", null));
//
